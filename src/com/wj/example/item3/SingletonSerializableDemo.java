...
class SerializationHelper{
    ...
    static void serialize(String filePath, Object obj) {
        ...
        try{
            os = new ObjectOutputStream(new BufferedOutputStream(new FileOutputStream(filePath)));
            os.writeObject(obj);
        }catch (IOException e){
            e.printStackTrace();
        }finally {
    ...
    static Object deserialize(String filePath){
        ...
        Object obj = null;
        try{
            os = new ObjectInputStream(new BufferedInputStream(new FileInputStream(filePath)));
            obj = os.readObject();
...
public class SingletonSerializableDemo {
    ...
    public static void main(String[] args) {
        ...
        String filePath = "resources/item3/not_serializable_object.txt";
        ...
        filePath = "resources/item3/serializable_object.txt";
